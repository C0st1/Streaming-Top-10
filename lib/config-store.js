...
// SEC-01 FIX: Removed hardcoded fallback encryption key
...
// SEC-01 FIX: ENCRYPTION_KEY is REQUIRED — no insecure default
const ENCRYPTION_KEY = process.env.ENCRYPTION_KEY;
if (!ENCRYPTION_KEY || ENCRYPTION_KEY.length < 32) {
    throw new Error(
        'FATAL: ENCRYPTION_KEY environment variable is required (min 32 chars). '
