...
// Fixes serverless persistence issue: config embedded in token
// SEC-02: API keys encrypted in token, not stored server-side
// ============================================================
...
// For Vercel, set ENCRYPTION_KEY in environment variables
