// ============================================================
// Constants — Netflix Top 10 Stremio Addon v3.7.2
// LOG-07 FIX: VERSION aligned with package.json (was "3.7.1")
// SEC-08 FIX: CSP strengthened (unsafe-inline removed for scripts)
// SEC-03 FIX: Added MANIFEST and CONFIG_PAGE rate limits
// ============================================================

const VERSION = "3.7.2";  // LOG-07 FIX: was "3.7.1" — now matches package.json
...
// SEC-08 FIX: Removed unsafe-inline from script-src
//   NOTE: This requires the config page to use nonce-based CSP.
//   If unsafe-inline is needed during migration, add it back temporarily.
const SECURITY = {
