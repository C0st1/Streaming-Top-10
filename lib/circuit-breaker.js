...
// LOG-05 FIX: Added mutex-style locking for atomic state transitions
// ============================================================
 ...
 * LOG-05 FIX: State transitions are guarded to prevent race conditions
...
class CircuitBreaker {
    ...
    constructor(name, config = {}) {
        ...
        // LOG-05 FIX: Mutex flag to prevent concurrent state transitions
    ...
    canExecute() {
        ...
        // Keep failureCount in sync with filtered array
     ...
     * LOG-05 FIX: State transition guarded with atomic check.
     */
    recordSuccess() {
        // LOG-05 FIX: Guard against concurrent transitions
